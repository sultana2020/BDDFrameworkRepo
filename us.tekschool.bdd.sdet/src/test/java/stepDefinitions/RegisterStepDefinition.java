...
public class RegisterStepDefinition extends Base {
	...
	// create object of register page object class
...
//		registerPageObj.enterConfirmPassValue(dataValues.get(0).get(4));
		...
		//when use List<List> for processing datatable uses raw method
		//when use Lis<Map> use .asMaps(String.class, String.class)
